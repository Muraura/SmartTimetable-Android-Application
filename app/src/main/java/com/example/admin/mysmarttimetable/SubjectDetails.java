...
String subject_selected = SubjectActivity.subjectPreference.getString(SubjectActivity.SUB_PREF,null);
 ...
 }else if(subject_selected.equalsIgnoreCase("MathsforScience")){
     syllabus = getResources().getStringArray(R.array.MathsforScience);
        }else{
